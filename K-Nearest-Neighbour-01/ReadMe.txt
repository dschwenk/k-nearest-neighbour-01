========================================================================
    KONSOLENANWENDUNG: K-Nearest-Neighbour-01-Projektübersicht
========================================================================

Diese K-Nearest-Neighbour-01-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre K-Nearest-Neighbour-01-Anwendung besteht.


K-Nearest-Neighbour-01.vcxproj
...
K-Nearest-Neighbour-01.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "K-Nearest-Neighbour-01.pch und eine 
